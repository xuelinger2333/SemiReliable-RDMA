...
A2 SemiRDMA 12 cells（`docs/phase3/results-cx6lx25g-c240g5/rq6-prep-a2-real-nic/`）:
...
B.5 RC-Baseline / RC-Lossy（`docs/phase3/results-cx6lx25g-c240g5/rq6-b5-rc-baselines/`）:
